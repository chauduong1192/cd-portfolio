      ...
      <DialogContent className='overflow-hidden p-0'>
        <Command
          className='[&_[cmdk-group-heading]]:px-2 [&_[cmdk-group-heading]]:font-medium
            [&_[cmdk-group-heading]]:text-gray-dark
...
>(({ className, ...props }, ref) => (
  <div className='flex items-center border-b px-3' cmdk-input-wrapper=''>
    ...
    <CommandPrimitive.Input
      ref={ref}
      className={cn(
        `flex h-10 w-full rounded-md bg-transparent py-3 text-sm outline-none bg-white
        placeholder:text-gray disabled:cursor-not-allowed text-gray-dark
        disabled:opacity-50`,
        className,
      )}
      {...props}
...
>(({ className, ...props }, ref) => (
  <CommandPrimitive.Item
    ...
    className={cn(
      ...
      text-gray-medium py-1.5 text-sm outline-none
      data-[disabled=true]:pointer-events-none data-[selected=true]:text-black-light
