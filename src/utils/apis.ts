    ...
    experience: [
      {
        ...
        desc: 'In the period of 6 months, I had a chance to working with backend team and BA team to define, design, implement the new payment flow solution for new Philipin area based on Java Spring Boot, BDD testing, Microservices, Serverless and AWS',
      },
      {
        projectName: 'Internet Banking',
        url: 'https://bank.tymedigital.co.za/',
        desc: 'Maintenance and develop many new features for IB as bill payment, goal save, new gen for pin pad.',
      },
      {
        projectName: 'The Bamboo Mock',
        url: 'https://github.com/chauduong1192/thebambooMock',
        desc: 'The extension helps my team by mocking API and changing their response, esponse time and status, user can try all test case scenario like long loading time, error states, or any missing or incorrect data. ',
      },
    ],
  },
  {
    ...
    experience: [
      ...
      },
      {
        ...
        desc: 'Build up the static page based on gastby, styled-jsx and using headless cms (strapi) to manage the content.',
      },
      {
